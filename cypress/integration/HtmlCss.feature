Feature: W3.org html css page scenarios
    ...
    Scenario: No console errors found
        Given I visit "https://www.w3.org/standards/webdesign/htmlcss"
        Then I see no console errors
        
    Scenario: Check status code
        Given I fetch "https://www.w3.org/standards/webdesign/htmlcss"
